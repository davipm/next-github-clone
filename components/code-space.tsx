...
export default function CodeSpace() {
  return (
    <div className="flex bg-code-space bg-cover md:pl-10">
        ...
        <div className="my-8 flex items-center pb-6 max-md:flex-col-reverse sm:my-12 md:my-16 md:flex-row md:pb-20 lg:gap-x-5">
          <div className="mb-2 w-full py-4">
            <motion.div
              ...
              className="md:pr-6"
            >
              <h2 className="mb-4 w-full text-2xl text-custom-gray max-lg:text-xl max-md:w-10/12 lg:w-full">
          ...
          <div className="relative flex w-full flex-row px-6 py-4">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
